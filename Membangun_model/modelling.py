...
dagshub.init(repo_owner='fahrimuda12', repo_name='my-first-repo', mlflow=True)
# Set MLflow Tracking URI
# mlflow.set_tracking_uri("http://127.0.0.1:5000/")
mlflow.set_tracking_uri("https://dagshub.com/fahrimuda12/my-first-repo.mlflow")

# Create a new MLflow Experiment
mlflow.set_experiment("Online Training Performance Habits Student")

# Nama eksperimen yang ingin dicari
experiment_name = "Online Training Performance Habits Student"
...
# Memuat dataset 
data = pd.read_csv('dataset/failure_heart_preprocessingv', sep=',')
...
with mlflow.start_run():
    for i in range(n_batches):
        ...
        joblib.dump(clf, f"model_batch_{i+1}.pkl")
    ...
    # Log final model
    mlflow.sklearn.log_model(clf, "model_final")
